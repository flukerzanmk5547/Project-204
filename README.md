...
| # | ฟีเจอร์ | สถานะ | หมายเหตุ |
| --- | --- | --- | --- |
| 8.1 | แผงประเมิน (คะแนน / วัตถุประสงค์) | 🟡 | กรอกและกดส่งได้ แต่ข้อมูลหายเมื่อปิดหน้า (ไม่ได้บันทึกที่ใดเลย) |
...
| --- | --- | --- | --- |
| 10.1 | Module ที่มีจริง (19) | ✅ | auth, product, category, cart, banner, homepage, promotion, bundle, attribute, recommendation, address, order, payment, favorite, notification, dashboard, analytics, superadmin, review |
...
| 10.7 | ฐานข้อมูล 30 ตาราง | ✅ | migration `001` – `013` |
...
| 2 | ระบบ Feedback ส่งเข้า backend | ตอนนี้เป็น UI อย่างเดียว ยังไม่มีตารางเก็บและยังไม่มี API — ต้องสร้าง migration ใหม่ | |
| 3 | Toast แจ้งเตือนหน้าอื่น | ทำแล้วเฉพาะ `/favorites` — หน้าสินค้า / หมวดหมู่ / หน้าแรก ยังไม่มี feedback ตอนกดใส่ตะกร้า | |
